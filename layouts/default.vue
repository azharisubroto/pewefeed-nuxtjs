    ...
    <v-sheet>
      ...
      >
        ...
        <v-toolbar-title @click="$router.push('/'); drawer = false" class="px-0">
          <!-- {{$route.name}} -->
          <template
            v-if="$route.name == 'member-pengaturan' || $route.name == 'member-pengaturan-profil'"
          >
          ...
          <template
            v-else-if="$route.name == 'tukarpoin' || $route.name == 'tukarpoin-redeem-detail'"
          >
      ...
      <v-content class="maincontent" :class="$route.name">
        ...
        >
          ...
          <v-btn @click="$router.push('/');wowtab= 0">
            ...
            <img
              :src="wowtab == 0 ? '/img/icons/nav-1-color.svg' : '/img/icons/nav-1-white.svg'"
              class="mb-1 d-block"
              width="20"
              height="20"
            />
          </v-btn>
          <v-btn @click="$router.push('/?tab=1'); wowtab= 1">
            <span class="text-11 d-inline-block mt-1">Tukar Poin</span>
            <img
              :src="wowtab == 1 ? '/img/icons/nav-2-color.svg' : '/img/icons/nav-2-white.svg'"
              class="mb-1 d-block"
              width="20"
              height="20"
            />
          </v-btn>
          <v-btn @click="$router.push('/?tab=2'); wowtab = 2">
            <span class="text-11 d-inline-block mt-1">Tantangan</span>
            <img
              :src="wowtab == 2 ? '/img/icons/nav-3-color.svg' : '/img/icons/nav-3-white.svg'"
              class="mb-1 d-block"
              width="20"
              height="20"
            />
          </v-btn>
          <v-btn @click="$router.push('/?tab=3'); wowtab = 3">
            <span class="text-11 d-inline-block mt-1">Netizen</span>
            <img
              :src="wowtab == 3 ? '/img/icons/nav-4-color.svg' : '/img/icons/nav-4-white.svg'"
              class="mb-1 d-block"
              width="20"
              height="20"
            />
          </v-btn>
          <v-btn @click="$router.push('/?tab=4'); wowtab = 4">
            <span class="text-11 d-inline-block mt-1">Me</span>
            <img
              :src="wowtab == 4 ? '/img/icons/nav-5-color.svg' : '/img/icons/nav-5-white.svg'"
              class="mb-1 d-block"
              width="20"
              height="20"
            />
