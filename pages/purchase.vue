                ...
                >
                  <v-list-item-content>
                    <v-list-item-title style="line-height: 23px">
                      ...
                      <span class="d-block"
                        >{{ item.price }} (exclude PPN 10%)</span
                      >
                    </v-list-item-title>
                  </v-list-item-content>
                  <v-list-item-icon>
            ...
            >
              <v-container class="pb-0">
                <v-alert color="#0057FF" class="mb-1" prominent>
                  ...
                  Pilih salah satu metode pembelian, bisa dengan SMS atau WAP
                  (Instan)
                </v-alert>
              </v-container>
                    ...
                    >
                      ...
                      <v-tabs-items v-model="buymethod" class="mt-4">
                        ...
                        >
                          ...
                          >
                            <strong class="body-2"
                              >Pastikan anda tidak menggunakan WiFi, kemudian
                              beri centang pada Google ReCaptcha dan tekan
                              tombol "Process", dan anda akan diarahkan ke
                              halaman pembayaran</strong
                            >
                          </v-container>
                        </v-tab-item>
                        <v-tab-item
