  ...
  <section>
    ...
    <template v-if="periode != null && isloading == false">
      ...
      <template v-if="tptab == 0">
                  ...
                  <v-row no-gutters align="center">
                    ...
                    >
                      <img
                        ...
                        style="vertical-align: center"
                      />
                      <strong style="color: #000" class="text-12">{{
                        item.ranked
                      }}</strong>
                    </v-col>
        ...
        <v-container v-else class="text-center"> Loading data... </v-container>
      </template>
            ...
            <template>
              ...
              <div :key="'winnersz-' + i" class="px-4">
                <v-row>
                  ...
                  <v-col cols="8">
                    {{
                      [item.periode.start_at, "YYYY-MM-DD HH:mm:ss"]
                        | moment("DD MMM")
                    }}
                    -
                    {{
                      [item.periode.end_at, "YYYY-MM-DD HH:mm:ss"]
                        | moment("DD MMM YYYY")
                    }}
