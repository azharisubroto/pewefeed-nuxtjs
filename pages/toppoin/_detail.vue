			...
			<div class="py-3">
				...
				<template v-if="description == true">
					<section class="toppoin-acc">
						<v-expansion-panels v-for="index in 5" :key="index">
							<v-expansion-panel class="mb-0">
								<v-expansion-panel-header>APA ITU TOP POIN</v-expansion-panel-header>
								<v-expansion-panel-content class='caption'>
									Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tenetur ut ex esse fuga perferendis deserunt commodi numquam consequuntur at praesentium quidem quia est sint, debitis earum hic provident exercitationem illo.
