			...
			<v-row>
				<v-col>
					<div class="text-center">
						<div class="text-40">
							<strong>{{
								userdata.point_total
									? numberWithCommas(userdata.point_total)
									: "0"
							}}</strong>
						</div>
					</div>
			...
			>
				<v-col cols="12" class="px-0">
					<v-btn
						...
						:class="[position == 'all' ? 'active' : null]"
						text
						dark
						small
					>
					...
					<v-btn
						...
						:class="[position == 'dapat' ? 'active' : null]"
						text
						dark
						small
					>
					...
					<v-btn
						...
						:class="[position == 'tukar' ? 'active' : null]"
						text
						dark
						small
					>
					...
					<v-btn
						...
						:class="[position == 'fraud' ? 'active' : null]"
						text
						dark
						small
					>
