			...
			<v-container style="margin-top: -100px">
				<template v-if="winners != null && winners.length > 0">
					<template v-for="(item, i) in winners">
						<v-card
							@click="
								$router.push('/sing/winner/detail/' + item.id)
							"
							:key="'videoasdas-' + i"
							color="#404040"
							class="px-4 pt-4 pb-2 mb-4"
						>
							<div class="mb-3">
								<img
									v-if="item.stage == 'Final'"
									src="/img/icons/stage-2.svg"
									style="vertical-align: middle"
									width="20"
									class="mr-2 makewhite"
									alt=""
								/>
								<img
									v-if="item.stage == 'Semi Final'"
									src="/img/icons/stage-1.svg"
									style="vertical-align: middle"
									width="20"
									class="mr-2 makewhite"
									alt=""
								/>
								<img
									v-if="item.stage == 'Audition'"
									src="/img/icons/stage-0.svg"
									style="vertical-align: middle"
									width="20"
									class="mr-2 makewhite"
									alt=""
							...
							<div class="d-flex justify-space-between">
								...
								<div
									class="singmetaicons text-14 d-flex align-center justify-content-end metasing pt-1"
								>
...
export default {
	...
	methods: {
		async getWinnerDetail() {
			try {
				const res = await SingService.winnersDetail(
					this.$route.params.winner
				)
