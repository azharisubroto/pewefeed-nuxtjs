...
export default {
	...
	async fetch({ store, params }) {
		...
		let item = await ComicService.getDetail(params.detail).then((res) => {
			...
			meta: [
				{
					...
					content: this.item.content.short_content,
				},
				// Facebok
				{
					hid: "og:title",
					property: "og:title",
					content: this.item.content.title,
				},
				{
					hid: "og:description",
					property: "og:description",
				...
				{ hid: "og:url", property: "og:url", content: site_url },
				{
					hid: "og:image",
					property: "og:image",
					content: this.item.content.thumbnail,
				},
				{
					hid: "og:image:width",
				...
				},
				{
					...
					content: this.item.content.description,
				},
				{
					hid: "twitter:image",
					name: "twitter:image",
