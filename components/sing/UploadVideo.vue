<template>
	<v-bottom-sheet v-model="thisVisible" persistent>
		<v-sheet
			height="100%"
			:class="[uploadStatus == 'loading' ? 'modalloading' : '']"
		>
				...
				<v-container class="text-left">
					<template v-if="uploadStatus == 'start'">
						<div class="text-12 mb-2">
							Di platform manakah video di upload?
						</div>
						...
						>
							...
							<v-btn
								value="youtube"
								style="border-left-width: 1px !important"
							>
								Youtube
							</v-btn>
							<v-btn
						...
						<div class="text-12 mb-2 mt-4">
							Paste URL yang kamu dapatkan dari IG, Youtube atau
							Tiktok
						</div>
						<v-text-field
