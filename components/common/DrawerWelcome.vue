			...
			<v-card style="border-radius: 0 !important">
				...
				<div class="px-4 pt-10 text-center">
					...
					<div class="mt-5 mb-0 text-14">
						Terima kasih sudah mengunjungi kembali pewefeed.com,
						untuk itu kamu mendapat 10 Poin Extra. Klaim Sekarang!
					</div>
				</div>
	...
	methods: {
		async claim() {
			...
			try {
				...
				if (res.status == 201) {
					var href =
						process.env.mobileUrl + "member/histori_penggunaan_poin"
