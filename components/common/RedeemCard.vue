				...
				<v-row align="center">
					...
					<v-col cols="9" class="pr-4">
						<v-row no-gutters class="mx-0">
							...
							<v-col cols="10">
								<strong
									class="text-20 black--text d-block mt-1"
									style="line-height: 1"
									>{{ data.redeem.price }} Poin</strong
								>
							</v-col>
						</v-row>
						<div
							class="devider-small my-3"
							style="border-color: #000"
						></div>

						<div class="text-18 black--text mb-2">
							{{ data.redeem.title }}
						</div>
						...
						<v-btn
							...
							@click="
								$router.push(
									'/tukarpoin/redeem/' + data.redeem.id
								)
							"
							>Tukar Poin</v-btn
						>
