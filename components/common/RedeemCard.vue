<template>
    <v-card class="mt-4" elevation="0" v-if="data" @click="$router.push('/tukarpoin/redeem/'+data.redeem.id)">
        <div>
            <div :class="['orange jangan lighten-1 py-2', 'px-7']">
              <v-row align="center" class="py-0">
                  <v-col cols="4">
                      <v-img :aspect-ratio="1/2" :src="data.redeem.image" contain></v-img>
                  </v-col>
                  <v-col cols="8">
                      <v-row>
                          <v-col cols="2" style="margin-top: -5px !important">
                              <v-img
                          ...
                          <v-col cols="10" style="margin-left: -15px" justify="center" align="left" class="pt-0">
                                <div class="text-20">
                                ...
                                <template>
                                  ...
                                  <div></div>
                                  <v-btn class="mt-3" color="deep-orange" dark depressed>TUKAR POIN</v-btn>
                                </template>
                          </v-col>
                      </v-row>
                  </v-col>
