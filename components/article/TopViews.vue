<template>
	<div class="pb-5 promo_news scroller">
		...
		>
			...
			>
				<v-icon dark v-if="isvideo" :size="30" class="playbutton"
					>mdi-play-circle-outline</v-icon
				>
				<v-img
					:src="
						article.image ? article.image.small : article.thumbnail
					"
					:aspect-ratio="2 / 2.5"
				>
					<div
						class="align-end white promo_caption pa-2 text--light gray"
					>
						<div
