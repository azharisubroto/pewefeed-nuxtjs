<template>
    <div v-if="userdata!=null && userdata.verified != true">
        <v-list color="transparent" class="my-0 profile-menus" style="background: transparent">
            <v-list-item-group color="transparent" class="my-0 py-0" style="background: transparent">
              <!-- WHATSAPP -->
              <v-list-item href="/member/otp" class="my-0 py-0" style="border: 2px solid red">
