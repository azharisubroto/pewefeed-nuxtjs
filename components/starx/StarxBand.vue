...
<template class="pb-5">
	<div class="StarxBandHome">
		...
		<v-container v-else class="pb-5" ma-0 pa-0>
			...
			<v-container v-if="tab != 'tab-2' && tab != 'tab-4' && tab != 'tab-3'" style="margin-top: 10px">
				<v-alert
				border="left"
				dense
				colored-border
				...
				>
					...
					<template v-if="video_finalist">
						...
						<v-container v-else>
							<v-row>
								<v-col cols="12" md="4">
									<h3 class="pwhead text-uppercase"><span>Judges Choice</span></h3>
									<div
							...
							<v-row class="mt-4">
								<v-col cols="12" md="4">
									<h3 class="pwhead text-uppercase"><span>Voters Choice</span></h3>
									<div
														...
														<v-list-item-content>
															...
															<v-row v-if="latest.band" class="sm">
																...
																<v-col cols="10" class="py-0">
																	<strong style="font-size:14px;">{{latest.personnel_winner ? latest.personnel_winner.asal_band : ''}}</strong>
									...
									<v-list-item-content>
										<v-list-item-title>
											<div style="color:#000!important;font-size:14px">
												...
												<v-icon color="orange accent-3" small class="mr-2"> mdi-star</v-icon>{{ prize.minimun_star }} | Juara ke - {{ (i+1) }}
											</div>
										</v-list-item-title>
									</v-list-item-content>
								</v-list-item>
					...
					<v-container>
						...
						>
							<v-expansion-panel class="mb-6">
								<v-expansion-panel-header>PENJURIAN &amp; PEMENANG</v-expansion-panel-header>
						...
						<v-expansion-panels>
						<v-expansion-panel class='mb-6'>
						<v-expansion-panel-header>SYARAT DAN KETENTUAN PESERTA</v-expansion-panel-header>
						<v-expansion-panel-content class='caption'>
						...
						<v-expansion-panels>
						<v-expansion-panel class='mb-6'>
						<v-expansion-panel-header>SYARAT DAN KETENTUAN VOTER</v-expansion-panel-header>
						<v-expansion-panel-content class='caption'>
							STAGE: AUDITION
							<br>
							<ul>
						...
						>
							<template v-if="item == 'STARX'">
								...
								<v-container>
									...
									<v-expansion-panels>
									<v-expansion-panel class='mb-6'>
									<v-expansion-panel-header>PENDAHULUAN</v-expansion-panel-header>
									<v-expansion-panel-content class='caption'>
										TUJUAN
										<br>
										...
										<ul>
											<li class="caption">Meningkatkan minat dan bakat siswa dalam bidang olahraga dan seni.</li>
											<li class="caption">Mengembangkan rasa persatuan, persahabatan, dan kerja sama antar siswa SMA Regina Pacis dengan siswa sekolah se-Jabodetabek.</li>
											<li class="caption">Merealisasikan semboyan Regina Pacis yaitu “Ad veritatem Per caritatem”, yang memiliki arti mencapai kebenaran melalui cinta kasih yang terwujudkan dalam persaudaraan antar sekolah melalui bidang olahraga dan seni.</li>
											<li class="caption">Mempromosikan SMA Regina Pacis sebagai sekolah yang bukan hanya berprestasi dalam bidang akademis, namun juga dalam bidang non- akademis seperti olahraga dan seni.</li>
										</ul>
									</v-expansion-panel-content>
									</v-expansion-panel>
									</v-expansion-panels>
									...
									<v-expansion-panels>
									<v-expansion-panel class='mb-6'>
									<v-expansion-panel-header>TENTANG STARX</v-expansion-panel-header>
									<v-expansion-panel-content class='caption'>
									...
									<v-expansion-panels>
									<v-expansion-panel class='mb-6'>
									<v-expansion-panel-header>TUJUAN VISI DAN MISI</v-expansion-panel-header>
									<v-expansion-panel-content class='caption'>
										<p>Acara “STAR X” ini dilaksanakan dengan tujuan sebagai berikut:</p>
									...
									<v-expansion-panels>
									<v-expansion-panel class='mb-6'>
									<v-expansion-panel-header>FILOSOFI</v-expansion-panel-header>
									<v-expansion-panel-content class='caption'>
											STAGE: AUDITION
											<br>
									...
									<v-expansion-panels>
									<v-expansion-panel class='mb-6'>
									<v-expansion-panel-header>PANITIA</v-expansion-panel-header>
									<v-expansion-panel-content class='caption'>
									...
									<v-expansion-panels>
									<v-expansion-panel class='mb-6'>
									<v-expansion-panel-header>HUBUNGI STARX</v-expansion-panel-header>
									<v-expansion-panel-content class='caption'>
