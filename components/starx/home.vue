    ...
    <v-container class="grey lighten-5">
        ...
        >
            <v-list-item three-line>
                <v-list-item-content>
                    <v-list-item-title class="mb-1">{{ program.headline }}</v-list-item-title>
                    <v-list-item-subtitle>{{ program.desc }}</v-list-item-subtitle>
                </v-list-item-content>
            ...
            <v-card-actions>
                <v-btn
                @click="$router.push( program.url )"
                color="deep-orange" dark depressed small
                >Lihat</v-btn>
            </v-card-actions>
        </v-card>
