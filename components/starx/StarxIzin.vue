                    ...
                    >
                        ...
                        <v-card-text>
                            <span class="text--primary">
                                <span><strong>Data Sekolah</strong></span><br> <br>
                                <span>{{ schoolData.name }}</span><br>
                                <span>SKP: <span v-if="isuploaded"><a :href="skp" target="_BLANK">Download</a></span><span v-else>Belum Ada</span></span>
                            </span>
                        </v-card-text>
