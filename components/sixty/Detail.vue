  ...
  <section>
    ...
    <v-container v-if="article" class="mb-5 pb-5">
      ...
      <div class="mb-1 caption">
        <div class="d-inline-block mr-2 mb-3">HOME / VIDEO / {{ article.article.type }}</div>
            ...
            >
              ...
              <v-col cols="8" class="d-flex align-content-space-between flex-wrap">
                ...
                <div class="meta text--gray" style="font-size:12px;">
                  <span :class="article.detail.type">{{article.detail.type}}</span>
                  - {{article.detail.published_at ? article.detail.published_at : article.detail.publish_at}}
                </div>
              </v-col>
            </v-row>
            <!-- WRITER -->
