			...
			<v-card class="mx-auto mb-2">
				<v-container>
					<v-row>
						...
						>
							<strong class="headline deep-orange--text">{{
								item
							}}</strong>
						</v-col>
					</v-row>
				...
				<v-tab-item value="customer">
					<v-container>
						...
						<p>
							...
							<br />
							<strong class="body-2">{{
								userdata.no_tlp ? userdata.no_tlp : "-"
							}}</strong>
						</p>
						<p>
		...
		<v-col cols="12">
			<v-card class="mx-auto mb-2">
				...
				<strong class="caption"
					>Pilih salah satu metode pembelian berikut</strong
				>
				<v-divider></v-divider>
					...
					<v-tab-item value="sms">
						<v-form ref="form" v-model="valid" lazy-validation>
							<v-container>
								...
								<strong class="caption"
									>Masukkan nomor handphone kamu</strong
								>
								<v-text-field
									label="+62"
									prepend-inner-icon
								...
								<strong class="caption"
									>Cetang kotak dibawah ini untuk melanjutkan
									proses</strong
								>
								<vue-recaptcha
									class="mt-2"
