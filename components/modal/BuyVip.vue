					...
					<v-stepper-items>
						...
						<v-stepper-content step="1" class="px-0">
							<v-card class="grey darken-2 mx-auto" tile>
								<v-card-title
									class="subtitle-1 grey darken-3 font-weight-bold"
									>Dengan Pulsa</v-card-title
								>
								<v-divider></v-divider>
						...
						<v-stepper-content step="2" class="mb-3 px-0">
							...
							<v-card class="grey darken-2 mb-3 mt-4">
								<v-card-title
									class="subtitle-1 grey darken-3 font-weight-bold text-16"
						...
						<v-stepper-content step="3" class="px-0 text-14">
							...
							<v-card class="grey darken-2 mb-3 mt-4">
								<v-card-title
									class="grey darken-3 font-weight-bold subtitle-2"
									>Berlangganan</v-card-title
								>
								<v-divider></v-divider>
								<div
									@click="
										wap = 'indosatlangganan'
										setOrder(
											indosatvoucherid,
											userdata.email,
											indosatlabel,
						...
						<v-stepper-content step="4" class="px-0">
							...
							<v-container class="mt-4 card-trans">
								<v-row style="margin-top: -10px">
									<v-col cols="12">
										<div class="text-14 mb-2">
											Channel Pembayaran (Pilih Salah
											Satu)
										</div>
										<v-card
											class="grey darken-2 mx-auto mb-2"
										>
											<v-tabs
												grow
												v-model="buymethod"
